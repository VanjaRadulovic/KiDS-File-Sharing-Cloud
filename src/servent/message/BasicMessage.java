...
//	public BasicMessage(MessageType type, String senderIpAddress, int senderPort, String receiverIpAddress, int receiverPort, String messageText, int requesterId, FileInfo fileInfo) {
//		this.type = type;
//		this.senderIpAddress = senderIpAddress;
//		this.senderPort = senderPort;
//		this.receiverIpAddress = receiverIpAddress;
